...
def render_in_one_pose(render_pose, hwf, K, chunk, render_kwargs, gt_imgs=None, savedir=None, render_factor=0):
    H, W, focal = hwf
...
def raw2outputs(raw, z_vals, rays_d, raw_noise_std=0, white_bkgd=False, pytest=False):
    ...
    return rgb_map, disp_map, acc_map, weights, depth_map, rgbs_map
