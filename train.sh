...
nohup python -u run_with_entropy.py --config configs/lego.txt --expname blender_paper_lego_alpha_entropy_10_10 --i_print 1000 > ./log/lego_alpha_entropy_10_10.log 2>&1 &